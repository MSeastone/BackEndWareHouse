...
namespace BackEndWareHouse
{
    public class Blob : I3DStorageObject
    {
        ...
        public Blob(int _id, string _description, int _weight, int _side, int _insuranceValue)
        {
            double convertToKvadratM = Math.Pow(_side, 3) / 1000000; //area
            double convertToKubikM = ((_side * _side) * 6) / 10000; // volym
            this.Side = _side;
            this.ID = _id;
